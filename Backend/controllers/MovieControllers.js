...
export const addMovie = async (req, res, next) => {
    ...
    // Create new movie
    const { title, cast, description, duration, releaseDate, posterUrl, trailerUrl } = req.body;
    if (!title.trim() || !cast.trim() || !description.trim() || !duration.trim() || !releaseDate.trim() || !posterUrl.trim()) {
